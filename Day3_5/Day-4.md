...
![image](Simple%20cpu%20architecture.png)
...
![image](immediate%20value.png)
![image](Other%20instruction%20fields.png)
![image](IRSBJU.png)
![image](Decode%20individual%20instructins.png)


### Lab outputs and codes for day 4

#### Fetch and Decode Output

![image](Day%204%20output%201.png)
...
\TLV
   ...
   |cpu
      ...
      @1 
         ...
         $dec_vector[10:0] = {$funct7[5],$funct3,$opcode};
         $is_beq = $dec_vector ==? 11'bx_000_1100011;
         $is_bne = $dec_vector ==? 11'bx_001_1100011;
         $is_blt = $dec_vector ==? 11'bx_100_1100011;
         $is_bge = $dec_vector ==? 11'bx_101_1100011;
         $is_bltu = $dec_vector ==? 11'bx_110_1100011;
...
![image](final%20day%204.png)
![image](Testbench%20result.png)
